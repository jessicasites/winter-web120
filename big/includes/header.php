...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa" <?=$logo?>></i>Web Dev Examples and Research by Jessica Sites </a></h1>
  <nav id="cssmenu">
  <ul>
     <li><a href="http://jessicasites.com/web120/index.php"><span><i class="fa fa-fw fa-bank"></i> WEB120 Portal</span></a></li>
